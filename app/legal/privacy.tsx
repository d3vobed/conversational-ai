...
const PrivacyPolicy = (_: { dom?: import("expo/dom").DOMProps }) => {
  return (
    <ScrollView style={{ backgroundColor: "#000000" }}>
      <Head>
        <title>Privacy | Conversational AI 🤖</title>
      </Head>
      <Stack.Screen
        options={{
          headerShown: true,
      ...
      >
        ...
        <h2 style={{ color: "#ffffff" }}>Information We Collect</h2>
        <p>
        ...
        <h2 style={{ color: "#ffffff" }}>How We Use Information We Collect</h2>
        <p>
        ...
        <h2 style={{ color: "#ffffff" }}>Transparency and Choice</h2>
        <p>
        ...
        <h2 style={{ color: "#ffffff" }}>Information You Share</h2>
        <p>
        ...
        <h2 style={{ color: "#ffffff" }}>Information We Share</h2>
        <p>
          We do not share personal information with companies, organizations and
          individuals outside of our company unless one of the following
        ...
        <h2 style={{ color: "#ffffff" }}>Security of Information</h2>
        <p>
        ...
        <h2 style={{ color: "#ffffff" }}>When This Privacy Policy Applies</h2>
        <p>
          Our Privacy Policy applies to all of the services offered by our
          company and its affiliates, including services offered on other sites
        ...
        <h2 style={{ color: "#ffffff" }}>Changes</h2>
        <p>
